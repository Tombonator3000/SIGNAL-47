...
def describe_manifest(manifest):
    ...
    require(isinstance(package_id, str) and re.fullmatch(r"(?:Chapter09|Visual10|NightSky12|Menu14|Recovery15|Archive16|Workstation18)-[0-9a-f]{12}", package_id), "Invalid package id.")
