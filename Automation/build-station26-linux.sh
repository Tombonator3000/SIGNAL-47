...
bash Automation/Splat21/bounded.sh 4294967296 600 "$signal47_editor" -batchmode -nographics -quit -job-worker-count 2 -projectPath "$PWD/Unity" -executeMethod Signal47.Editor.Station26Build.Build -logFile "$PWD/Artifacts/Station26/build.log"
