...
namespace Signal47.Editor
{
    public static class StoryPass
    {
        public static void Dress(GameObject printer,GameObject phone,PrologueDirector director,Material paperMaterial)
        {
            ...
            var ink=new GameObject("PrintedText");ink.transform.SetParent(feed.transform,false);ink.transform.localPosition=new Vector3(0,.004f,0);ink.transform.localRotation=Quaternion.Euler(90,0,0);
